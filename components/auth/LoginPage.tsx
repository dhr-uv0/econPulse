    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-16 sm:px-8">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex gap-1 p-1 bg-[var(--muted)] rounded-xl mb-8 border border-[var(--border)]">
          ...
          >
            ...
            {loading ? 'Redirecting…' : mode === 'signin' ? 'Continue with Google' : 'Sign up with Google'}
          </Button>
