...
export const lessons: Lesson[] = [
  // ── Lesson 1: The Entrepreneurial Mindset ─────────────────────────────────────
  {
    ...
    content: {
      ...
      thinkAboutIt: {
        question:
          'A classmate argues that an entrepreneur who quits a stable corporate job, invests her entire life savings into an untested product idea, and skips customer research entirely because she wants to move fast is demonstrating exactly the risk tolerance and resilience this lesson describes. Is that assessment accurate? Use the distinction between controllable and uncontrollable risk, and between effectuation and recklessness, to evaluate the claim.',
        answer:
          'The classmate\'s assessment confuses risk tolerance with recklessness, and the two are not the same thing. Genuine entrepreneurial risk tolerance means disaggregating risk into what can be controlled and what cannot, then aggressively reducing the controllable portion — and whether customers actually want the product is one of the most controllable risks available, since it can be tested cheaply through interviews, landing pages, or small pre-sales before committing serious capital. Skipping customer research does not display boldness; it means leaving the single most manageable risk completely unaddressed. Committing an entire life savings with no defined loss limit also violates the effectuation principle of acceptable loss, which calls for entrepreneurs to define upfront how much they can afford to lose and to size their bets accordingly, rather than betting everything on an unvalidated assumption. A founder practising real effectuation would use her existing means — savings, skills, and network — to run a low-cost test of demand first, then scale investment only as evidence accumulates. What the classmate is describing is closer to gambling than to the calculated, information-seeking behaviour that distinguishes expert entrepreneurs from reckless ones.',
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt:
        'You are competing in a DECA Entrepreneurship role-play. SITUATION: You are a startup coach hired by Meridian Outfitters, a two-founder company that spent 14 months and $60,000 of personal savings developing a solar-powered phone charger built into a hiking backpack. Three weeks before their planned launch, a nearly identical product appeared on a crowdfunding platform from a competitor and reached its funding goal within 48 hours. The founders are demoralised, have stopped taking customer calls, and are seriously discussing shutting the company down before it ever launches. You have 10 minutes to advise them.\n\n(a) Identify which entrepreneurial mindset trait(s) from this lesson — opportunity recognition, risk tolerance, creativity, or resilience — are most urgently needed in this moment, and explain why. [4 marks]\n\n(b) Apply risk disaggregation: identify one controllable risk and one uncontrollable risk the founders now face, and recommend one specific action for managing each. [6 marks]\n\n(c) Using the effectuation framework, propose two concrete next steps the founders could take that work from their existing means (their prototype, their supplier relationships, their 14 months of expertise) rather than from a fixed original plan. [6 marks]\n\n(d) Draft the one sentence of coaching language you would say to reframe the competitor\'s launch as actionable information rather than a verdict on Meridian Outfitters\' idea, and justify why that reframing matters. [4 marks]',
      rubric:
        '(a) Correctly identifies resilience and/or opportunity recognition as most urgent, with reasoning tied to the specific scenario (2 pts). Explains why the trait matters now rather than listing all four generically (2 pts). Total: 4 pts.\n\n(b) Names one genuinely controllable risk (e.g., differentiation, positioning, speed to market) with a specific management action (3 pts). Names one genuinely uncontrollable risk (e.g., competitor timing, crowdfunding platform dynamics) with an appropriate response such as acceptance or contingency planning (3 pts). Total: 6 pts.\n\n(c) Each proposed next step is grounded in the founders\' existing means rather than a fixed abstract goal, and is concrete enough to act on within days, not months (3 pts each). Total: 6 pts.\n\n(d) Coaching sentence demonstrates cognitive reframing of the setback as information rather than defeat (2 pts). Justification explicitly connects the reframing to resilience as a learnable, applied skill rather than blind optimism (2 pts). Total: 4 pts.',
      exampleTopics: [
        'Distinguish opportunity recognition, risk tolerance, creativity, and resilience as separate, nameable traits rather than a vague list.',
        'Apply the controllable-vs-uncontrollable risk framework to a real competitive threat, not just define it abstractly.',
        'Use effectuation logic (available means, acceptable loss) instead of causation logic (fixed plan, sunk-cost thinking) to propose next steps.',
        'Demonstrate cognitive reframing of failure as actionable information, matching DECA\'s Advanced Exemplary standard for applied language.',
      ],
    },
    quiz: [
      {
  ...
  // ── Lesson 2: Business Models & Value Propositions ────────────────────────────
  {
    ...
    content: {
      ...
      thinkAboutIt: {
        question:
          'Two founders pitch competing fitness apps to a DECA judge. Founder A says: "Our app has AI-powered workout tracking, social leaderboards, and integrations with 12 wearable devices." Founder B says: "Our app helps time-strapped parents complete a full workout in 12 minutes without leaving home, so they stop feeling guilty about skipping the gym." The judge scores Founder B\'s value proposition higher even though Founder A listed more capabilities. Using the "so what" test, explain why the judge\'s scoring is justified, and identify exactly what Founder A would need to add to turn a feature list into a genuine value proposition.',
        answer:
          'The judge is right to score Founder B higher because Founder A recited a feature list — AI tracking, leaderboards, wearable integrations — without ever stating what those features mean for the customer\'s actual life, which is precisely what the "so what" test is designed to expose. Ask "so what" of each of Founder A\'s features and the pitch runs out of answers: so what if it tracks workouts with AI, so what if there is a leaderboard — no pain is named, no customer segment is specified, and no transformation is promised. Founder B, by contrast, names a specific customer segment (time-strapped parents), a specific pain (guilt over skipping the gym, lack of time), and a specific transformation (a full workout completed in 12 minutes at home). To fix Founder A\'s pitch, each feature needs to be pushed through the "so what" filter until it reaches an emotional or economic outcome: AI-powered tracking, so what — it personalises progression so users do not plateau and quit; wearable integration, so what — it removes the friction of manual logging that causes most fitness apps to be abandoned within two weeks. Only once features are rewritten as outcomes does Founder A have an actual value proposition rather than a specifications sheet.',
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt:
        'You are competing in a DECA Start-up Business Plan role-play. SITUATION: A local dry cleaner, Pressed & Polished, wants to add a subscription laundry pickup-and-delivery service alongside its existing walk-in storefront. The owner has asked you, an outside consultant, to redesign the Business Model Canvas for this new subscription line and to explain how it changes the underlying economics of the business.\n\n(a) Write a one-sentence, outcome-based value proposition for the subscription service that would pass the "so what" test — not a feature list. [4 marks]\n\n(b) Identify how three specific Business Model Canvas blocks (choose from Customer Relationships, Key Activities, Key Resources, or Cost Structure) must change compared to the existing walk-in-only model, and explain why each change is a direct consequence of the shift to a subscription structure. [9 marks]\n\n(c) Pressed & Polished\'s walk-in storefront has low operating leverage (mostly variable costs — hourly staff, per-garment cleaning supplies), while a delivery subscription requires a fixed-cost delivery fleet and route-planning software. Explain what this shift in operating leverage means for the business\'s risk profile if subscriber growth is slower than expected. [4 marks]\n\n(d) Using Porter\'s generic strategies, recommend whether the subscription line should compete primarily on cost leadership, differentiation, or focus, and justify your choice with one specific piece of evidence from the scenario. [3 marks]',
      rubric:
        '(a) Value proposition names a specific customer pain and the transformation delivered, not a list of service features (3 pts). Passes the "so what" test when read aloud (1 pt). Total: 4 pts.\n\n(b) Three blocks identified correctly as directly affected by the subscription shift (1 pt each, 3 pts total). Each change explained with specific reasoning connecting the subscription model\'s logic to that block, not a generic description (2 pts each, 6 pts total). Total: 9 pts.\n\n(c) Correctly explains that high operating leverage means profits swing more sharply with changes in volume — slow subscriber growth leaves fixed delivery and software costs unabsorbed, creating disproportionate downside risk compared to the mostly-variable walk-in model (4 pts). Total: 4 pts.\n\n(d) Clear recommendation of one generic strategy (1 pt) with justification tied to specific scenario evidence such as local reputation, convenience premium, or niche neighbourhood focus (2 pts). Total: 3 pts.',
      exampleTopics: [
        'Write a value proposition as a customer-outcome statement, not a feature list, and be able to defend it against the "so what" test.',
        'Trace how a single change (new revenue model) ripples through multiple Business Model Canvas blocks — Customer Relationships, Key Activities, Cost Structure.',
        'Apply operating leverage to explain how a shift from variable to fixed costs changes a business\'s downside risk.',
        'Apply Porter\'s generic strategies (cost leadership, differentiation, focus) to justify a specific competitive positioning choice.',
      ],
    },
    quiz: [
      {
  ...
  // ── Lesson 3: Startup Funding & Venture Capital ───────────────────────────────
  {
    ...
    content: {
      ...
      thinkAboutIt: {
        question:
          'A startup negotiates a $2 million investment at an $8 million pre-money valuation. The term sheet also requires the founders to create a 10% post-money employee option pool, carved out of the founders\' own equity before the round closes — a standard VC practice sometimes called the "option pool shuffle." What percentage of the company do the founders actually retain after the round, and why does this differ from the naive calculation a founder might do if they ignored the option pool?',
        answer:
          'A naive calculation would treat this as a simple 20% dilution: post-money valuation is $8 million pre-money plus $2 million invested, equal to $10 million, so the investor owns $2M ÷ $10M = 20%, leaving the founders with the remaining 80%. But that ignores the option pool, which is created before the new investor\'s money comes in and is carved entirely out of the existing shareholders\' equity — meaning the founders, not the incoming investor, absorb the dilution from the pool. Once the 10% post-money option pool is accounted for, the post-money cap table splits into three pieces rather than two: the investor still holds 20%, the option pool holds 10%, and the founders are left with the remaining 100% − 20% − 10% = 70%, not 80%. This is why experienced founders scrutinise the size and timing of the option pool as closely as the valuation itself — a larger pool or one carved out pre-money rather than shared proportionally after the round can quietly cost founders several additional percentage points of ownership that a headline valuation number does not reveal.',
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt:
        'You are competing in a DECA Entrepreneurship Team Decision Making role-play. SITUATION: You are advising Harvestly, a farm-to-table meal-kit subscription startup with $2.4 million in annual recurring revenue, growing at 18% year-over-year, and already profitable. The founder is meeting with a venture capital fund next week to pitch for $5 million in exchange for equity, and has asked your team to prepare her for the meeting.\n\n(a) Evaluate whether venture capital is an appropriate funding source for Harvestly given its current growth rate and profitability, using the power-law return logic VC funds require. [5 marks]\n\n(b) Recommend one alternative funding source better matched to Harvestly\'s profile, and justify the recommendation with reference to at least one trade-off (equity retained, speed of access to capital, or reporting obligations). [5 marks]\n\n(c) Harvestly\'s founder wants to state a $20 million pre-money valuation in the meeting. Explain what valuation methodology (comparables, revenue multiple, or discounted cash flow) she should cite to support that number, and why stating a bare figure without methodology is a common mistake. [5 marks]\n\n(d) If the VC fund ultimately declines to invest, draft two sentences of coaching advice explaining how the founder should interpret and respond to that outcome, using the concept of funding-source mismatch rather than treating the rejection as a verdict on the business itself. [5 marks]',
      rubric:
        '(a) Correctly applies power-law logic: VC needs 50–100x return potential across the fund, which requires hyper-growth in a very large addressable market (3 pts). Correctly concludes 18% growth, while healthy and profitable, is mismatched with VC return requirements (2 pts). Total: 5 pts.\n\n(b) Names a specific, appropriate alternative (e.g., revenue-based financing, a growth-stage bank loan, or continued bootstrapping from profits) (2 pts). Justifies with at least one concrete trade-off relevant to Harvestly\'s situation (3 pts). Total: 5 pts.\n\n(c) Names an appropriate methodology (most likely a revenue multiple given profitability and steady growth) (2 pts). Explains why citing a bare number invites skeptical follow-up questions the founder may not be prepared for (3 pts). Total: 5 pts.\n\n(d) Advice reframes the rejection as a funding-source mismatch rather than a rejection of the business\'s quality (3 pts). Advice is specific and actionable, e.g. redirecting toward growth-equity firms or revenue-based lenders whose model fits Harvestly\'s growth rate (2 pts). Total: 5 pts.',
      exampleTopics: [
        'Apply the power-law return logic to judge whether a specific company\'s growth profile fits VC economics.',
        'Match a startup\'s stage and growth rate to an appropriate funding source, not just name funding types in the abstract.',
        'Name and justify a specific valuation methodology (comparables, revenue multiple, DCF) rather than stating a bare number.',
        'Reframe a funding rejection as a mismatch between funding source and business model, not as a verdict on the business.',
      ],
    },
    quiz: [
      {
  ...
  // ── Lesson 4: DECA Entrepreneurship Event Formats ─────────────────────────────
  {
    ...
    content: {
      ...
      thinkAboutIt: {
        question:
          'A competitor has spent three months building a detailed plan for a new AI-powered scheduling tool that would be launched as a new internal product line inside her family\'s existing pet-supply retail company — not as a standalone startup. She has strong written research and financial modelling skills but tends to freeze up during unscripted questioning. Should she enter Start-up Business Plan (SBPL) or Innovation Plan (IP), and why does the detail that her idea lives "within an existing company" matter for that choice, even though both events include a written plan and an oral presentation to a panel that has already read it?',
        answer:
          'She should enter Innovation Plan, not Start-up Business Plan, and the "within an existing company" detail is the deciding factor rather than a side note. SBPL is built around evaluating a complete new venture across every functional area — market analysis, marketing plan, operations, management team, and three-year financial projections for a standalone business — which does not fit a project that will be launched inside an already-operating pet-supply company with its own existing management, operations, and customer base. Innovation Plan, by contrast, is explicitly designed to evaluate a new product, service, or process that can be implemented either as a standalone startup or within an existing company, judged on the originality of the innovation, the feasibility of implementation, and the financial case for adoption rather than on building out an entire new venture\'s functional plan. Her strengths in written research and financial modelling are well matched to IP\'s emphasis on a credible implementation pathway and grounded financial justification, and because both SBPL and IP oral rounds present to a panel that has already read the plan, her tendency to freeze during unscripted questioning is somewhat mitigated either way — but entering the wrong event category risks losing points for content that does not match what the rubric is actually designed to assess, regardless of how well-prepared her material is.',
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt:
        'You are competing in a DECA Entrepreneurship Team Decision Making event. SITUATION: You and a partner are given 30 minutes to prepare a joint recommendation for a scenario in which a boutique candle company must decide whether to expand into a new city or invest in e-commerce fulfilment technology. Halfway through your prep time, you and your partner realise you disagree: you favour the e-commerce investment, your partner favours the city expansion, and there is not enough time left to fully resolve the disagreement before entering the judge\'s room.\n\n(a) Explain why walking into the room with a visible, unresolved disagreement would damage your score, referencing the specific criterion judges use to assess this. [4 marks]\n\n(b) Describe the decision process your team should use in the remaining prep time to reach a single joint recommendation quickly, without simply having the more assertive partner override the other. [5 marks]\n\n(c) Draft one transitional sentence your partner could use to hand off from the problem analysis to your recommendation, demonstrating a coordinated, unified presentation rather than two separate monologues. [4 marks]\n\n(d) During judge interaction, the judge asks: "Did you two consider the city expansion option as seriously as fulfilment technology?" Draft a two-sentence joint response that acknowledges the alternative was considered without exposing the internal disagreement or contradicting your partner. [7 marks]',
      rubric:
        '(a) Correctly names "team effectiveness" as a distinct scored criterion (2 pts). Explains that visible disagreement or contradiction between partners loses points regardless of the quality of either individual\'s analysis (2 pts). Total: 4 pts.\n\n(b) Describes a concrete, time-bounded decision process (e.g., weighing each option against one shared criterion such as ROI or implementation risk, then committing) rather than vague "talk it out" language (3 pts). Process avoids one partner simply dominating the decision (2 pts). Total: 5 pts.\n\n(c) Transition sentence explicitly references the prior partner\'s analysis before introducing the recommendation, signalling a practised handoff (4 pts). Total: 4 pts.\n\n(d) Response acknowledges the alternative was genuinely evaluated (2 pts). Response gives a substantive, specific reason the chosen option was preferred (3 pts). Response shows no contradiction or visible daylight between partners (2 pts). Total: 7 pts.',
      exampleTopics: [
        'Distinguish ETDM, SBPL, and Innovation Plan by their deliverables and judging emphasis, not just their names.',
        'Apply the "team effectiveness" criterion to a realistic partner-disagreement scenario, not just define it.',
        'Practise an explicit transitional handoff between partners as a scored behaviour, not an afterthought.',
        'Respond to judge questions about internal team process without exposing disagreement or contradicting a partner.',
      ],
    },
    quiz: [
      {
  ...
  // ── Lesson 5: Pitch Competition Mastery ───────────────────────────────────────
  {
    ...
    content: {
      ...
      thinkAboutIt: {
        question:
          'During Q&A, a judge says: "Your SOM assumes you capture 15% of your $80 million SAM in year one, but most first-year startups capture under 1% of their addressable market. That seems unrealistic." This is clearly a challenge question. Using the three categories of Q&A questions and the norm around proactive risk disclosure from this lesson, describe what an Advanced Exemplary response would need to include, and explain why simply repeating the original 15% figure with confidence would not be enough on its own.',
        answer:
          'A challenge question requires acknowledging the judge\'s point respectfully and then either defending it with specific evidence or conceding gracefully and revising the claim — simply repeating the 15% figure with more confidence is a deflection, not an answer, and confident repetition of an unsupported number is exactly the kind of surface-level response that fails to earn Advanced Exemplary marks. A strong response starts by acknowledging that 15% is unusually high relative to typical first-year capture rates, then either supplies the specific evidence that justifies the outlier assumption — for example, an already-signed distribution partnership, a wait-list of pre-committed customers, or a comparable launch in an adjacent market that achieved a similar rate — or, if that evidence does not exist, revises the projection downward on the spot and explains the more defensible assumption behind the new number. Proactively naming the risk that the 15% assumption might be optimistic, before the judge has to extract it through further questioning, signals exactly the kind of intellectual honesty this lesson identifies as a hallmark of Advanced Exemplary pitches. Judges who catch an unsupported assumption being defended purely through confident tone, rather than evidence or an honest revision, will penalise the pitch far more heavily than they would a team that transparently named the uncertainty and showed how they would de-risk it.',
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt:
        'You are competing in a DECA Entrepreneurship Innovation Plan pitch round. SITUATION: You have 3 minutes to pitch Sprout, a subscription meal-kit service designed specifically for college dorm residents with only a microwave and mini-fridge. You must cover the canonical pitch structure and then handle judge Q&A.\n\n(a) Write a 60-90 second executive summary for Sprout that answers all four required questions: the problem, who experiences it, the solution, and why now. [6 marks]\n\n(b) State a specific TAM, SAM, and SOM for Sprout, and explain in one sentence each why your SOM is more credible to a judge than your TAM alone. [6 marks]\n\n(c) A judge asks a clarification question: "How exactly does the meal kit work with just a microwave?" Draft a direct, brief response, then confirm understanding with the judge in the way this lesson recommends. [3 marks]\n\n(d) A judge then asks a challenge question: "Dining halls already offer unlimited meals as part of tuition — why would a student pay extra for this?" Draft a response that acknowledges the challenge and either defends your assumption with evidence or concedes and adjusts it, rather than deflecting. [5 marks]',
      rubric:
        '(a) Executive summary clearly states the problem and who experiences it (2 pts), the solution (2 pts), and a "why now" element (2 pts) within the required length. Total: 6 pts.\n\n(b) TAM, SAM, and SOM each stated as a specific, plausible figure (3 pts total, 1 pt each). Explanation correctly argues that SOM demonstrates realistic understanding of customer and competitive constraints, which judges find more credible than an inflated TAM alone (3 pts). Total: 6 pts.\n\n(c) Response is direct, brief, and technically accurate (2 pts). Closes with a confirming check such as "Does that answer your question?" as modelled in the lesson (1 pt). Total: 3 pts.\n\n(d) Response acknowledges the challenge respectfully rather than dismissing it (2 pts). Response provides specific evidence (e.g., dining hall hours, food variety limitations, late-night access) or transparently revises the claim rather than repeating the pitch\'s original assumption unchanged (3 pts). Total: 5 pts.',
      exampleTopics: [
        'Structure an executive summary that answers problem, customer, solution, and timing within a strict time limit.',
        'State TAM, SAM, and SOM correctly and explain why SOM is the more credible number to lead a financial case with.',
        'Handle a clarification question with a direct answer plus a confirming check-back, per the lesson\'s Q&A framework.',
        'Handle a challenge question by acknowledging it and either defending with evidence or conceding and revising, never deflecting.',
      ],
    },
    quiz: [
      {
