...
The theory of clubs raises additional questions about optimal membership size and the optimal number of clubs in an economy. Buchanan's club model trades off the per-member cost savings from expanding membership against the congestion cost. The optimal club size N* satisfies: marginal congestion cost of the N*th member = per-member reduction in cost sharing. With free entry of clubs, a competitive equilibrium in the market for clubs can be efficient under certain conditions (Ellickson, 1979), connecting club theory to Tiebout's (1956) model of local public goods where households "vote with their feet," sorting across jurisdictions to find their preferred tax-public-good bundle — a decentralised mechanism that partially solves the preference-revelation problem without requiring Lindahl pricing.`,
      ...
      thinkAboutIt: {
        question: `The Lindahl equilibrium assigns each individual a personalised price equal to their own MRS at the efficient quantity G*, and these prices sum exactly to MRT — so by construction Lindahl equilibrium implements the Samuelson condition. If it achieves full Pareto efficiency, why is Lindahl pricing essentially never used in practice, and does the free-rider problem actually disappear under it, or does it simply relocate to an earlier stage of the game?`,
        answer: `The free-rider problem does not disappear under Lindahl pricing — it migrates from the contribution stage to the preference-revelation stage. Lindahl equilibrium is only efficient if the planner already knows each individual's true MRS function in order to set the personalised prices p_i = MRS_i(G*); in practice no planner observes preferences directly, so prices must be set through some mechanism that asks individuals to report their valuations. But an individual who understands that their personalised price rises with their reported valuation has a direct incentive to understate their true MRS, hoping to free-ride on a lower price while still consuming the same non-rival G. This is exactly the preference-revelation problem the Vickrey-Clarke-Groves literature studies, and the Green-Laffont theorem shows that any mechanism achieving efficiency and incentive-compatibility (truthful revelation as a dominant strategy) cannot also balance the budget for public goods. So Lindahl pricing is not a counterexample to the free-rider problem; it is simply the efficient benchmark that a truthful-revelation mechanism would have to hit, and the impossibility results explain precisely why no real mechanism reaches it without sacrificing budget balance, individual rationality, or incentive compatibility. A secondary practical obstacle is existence: with non-convexities in production or preferences, a Lindahl equilibrium may fail to exist even in principle, unlike competitive equilibrium for private goods under standard convexity assumptions.`,
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt: `Three individuals share a pure public good G. Their marginal willingness-to-pay (MRS) functions are: MRS_1 = 20 − G, MRS_2 = 16 − G, MRS_3 = 12 − G. The constant marginal cost of provision is MC = 18 (in units of the numeraire private good). (a) Write the Samuelson condition for this economy and solve for the efficient quantity G*. [4 marks] (b) Compute each individual's Lindahl personalised price at G* (i.e., each individual's MRS evaluated at G*), and verify that the three prices sum exactly to MC. [4 marks] (c) Now suppose G is instead supplied through a market in which each individual may purchase units of G at the uniform price MC = 18, acting as a private-good buyer who ignores the benefit their purchase confers on the other two. Derive each individual's private optimality condition, show that only individual 1 has positive demand at this price, and solve for the resulting Nash/market quantity G_market. [4 marks] (d) A club good has fixed provision cost F = 200 (shared equally among members) and a per-member congestion cost C(N) = 0.5N². Derive the club size N* that minimises average cost per member, F/N + C(N)/N, and state the minimised average cost. [4 marks] (e) Using the Green-Laffont theorem, explain why no incentive-compatible mechanism — including an attempt to implement Lindahl pricing via a preference-revelation game — can replicate the efficient outcome from part (a) while also balancing the government's budget, and state which property real-world tax-financed provision typically sacrifices instead. [4 marks]`,
      rubric: `(a) 4 marks: correctly states Σ MRS_i = MC (1); correctly sums to 48 − 3G = 18 (1); correct algebra 3G = 30 (1); correct G* = 10 (1). (b) 4 marks: correctly evaluates MRS_1(10) = 10 (1); MRS_2(10) = 6 (1); MRS_3(10) = 2 (1); correctly verifies 10 + 6 + 2 = 18 = MC (1). (c) 4 marks: correctly states private FOC MRS_i(G) = MC for a buyer treating G as an ordinary private purchase (1); correctly shows MRS_2(0) = 16 < 18 and MRS_3(0) = 12 < 18 so individuals 2 and 3 demand zero (1); correctly sets 20 − G = 18 for individual 1 alone (1); correct G_market = 2, with explicit comparison to G* = 10 showing 80% underprovision (1). (d) 4 marks: correctly writes average cost AC(N) = 200/N + 0.5N (1); correctly differentiates and sets dAC/dN = −200/N² + 0.5 = 0 (1); correct N* = 20 (1); correct minimised AC = 10 + 10 = 20 (1). (e) 4 marks: correctly states the Green-Laffont impossibility (efficiency + dominant-strategy incentive compatibility + budget balance cannot all hold for public goods) (2); correctly identifies that real-world provision typically sacrifices budget balance/uses distortionary taxes to cover the shortfall rather than sacrificing efficiency or incentive compatibility outright (2).`,
      exampleTopics: [
        'Samuelson condition: vertical summation of MRS curves and algebraic solution for G*',
        'Lindahl personalised pricing and verification that prices sum to marginal cost',
        'Private/Nash provision of public goods and corner-solution free-riding when the highest-value individual alone contributes',
        'Buchanan club-good optimal membership size via minimisation of average cost per member',
        'Green-Laffont impossibility theorem and its implications for real-world public goods finance',
      ],
    },
  },
  {
...
The Saez (2001) formula for optimal top marginal rates, τ* = 1/(1 + a·ε), neatly illustrates the key trade-offs. The Pareto parameter a ≥ 1 measures the thickness of the right tail of the income distribution (lower a means fatter tail, more revenue from top earners). The ETI ε captures distortionary cost. A higher ε makes taxation more costly, lowering τ*; a lower a (fatter tail) means top earners respond more to taxes in aggregate, also lowering τ*. Empirically, estimates of ε for top earners range from 0.1 to 0.5, and a typically lies between 1.5 and 3, implying revenue-maximising top rates between roughly 50% and 80% — substantially above current rates in most OECD countries, fuelling ongoing academic and policy debate.`,
      ...
      thinkAboutIt: {
        question: `The inverse elasticity rule prescribes the heaviest ad valorem tax rates on goods with the most inelastic demand. Staple foods, fuel, and life-saving medicines are precisely the goods poor households cannot easily substitute away from — i.e., the goods with the most inelastic demand for them. Does a purely efficiency-minded Ramsey planner therefore have a theoretical mandate to tax necessities most heavily? Identify the specific results that break this naive prescription once the representative-consumer assumption is dropped.`,
        answer: `The naive IER prescription is an artefact of the single- (or representative-) consumer assumption embedded in Ramsey's original 1927 derivation, which has no notion of distributional concern because it minimises deadweight loss for one agent's welfare alone. Once the model is extended to heterogeneous consumers, Diamond's (1975) "many-person Ramsey rule" adds a distributional correction term to each good's optimal tax formula: the covariance between the good's consumption share and the social marginal utility of income (or, equivalently, the net social marginal welfare weight) of the households who consume it. Because the social planner typically assigns higher marginal welfare weight to poorer households (declining marginal utility of income), goods disproportionately consumed by the poor receive a downward adjustment to their optimal tax rate even if their price elasticity alone would justify a high rate — the pure efficiency term from the IER is offset by a negative distributional term. A second, sharper result is the Atkinson-Stiglitz (1976) theorem: if preferences are weakly separable between consumption goods and leisure, no differentiated commodity taxation is needed at all — an optimally designed non-linear income tax alone achieves the government's distributional objective, and uniform (or zero) commodity taxes are then efficient. So the apparent conflict is resolved by recognising that Ramsey's IER answers only "how do we minimise DWL for a fixed revenue," not "how do we maximise social welfare," and richer models built on top of it explicitly correct for exactly this omission.`,
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt: `A government must raise revenue R = 1,000 by taxing goods A and B. Compensated own-price elasticities are ε_A = −0.8 and ε_B = −0.2; cross-price substitution effects are zero. Initial producer prices are p_A = 10, p_B = 5, and initial quantities are Q_A = 200, Q_B = 300. Deadweight loss for each good is approximated by DWL ≈ ½t²|ε|Q/p. (a) Using the inverse elasticity rule, derive the ratio t_A/t_B, and combine it with the revenue constraint t_A Q_A + t_B Q_B = R (treating quantities as approximately fixed) to solve numerically for t_A and t_B. [5 marks] (b) Compute the DWL generated by each tax and the total DWL under this IER-optimal scheme. Then compute the total DWL if the government instead levied a single uniform ad valorem rate τ on both goods raising the same revenue R, and compare the two totals. [4 marks] (c) The government separately sets its top income tax rate using the Saez formula τ* = 1/(1 + a·ε). At a Pareto parameter a = 2 and elasticity of taxable income ε = 0.4, compute the revenue-maximising top rate. Now suppose expanded offshore avoidance opportunities raise ε to 0.6; recompute τ* and explain the direction of the change. [4 marks] (d) Using your DWL figures from part (b), verify numerically that doubling a tax rate quadruples its DWL (holding elasticity and quantity fixed), and explain why this convexity favours spreading a given revenue requirement across many goods rather than concentrating it on few. [4 marks] (e) Explain, referencing the Diamond-Mirrlees production efficiency theorem and the many-person Ramsey rule, why the sharply differentiated tax rates found in part (a) should not be read as a general policy recommendation once distributional and production-efficiency considerations are included. [3 marks]`,
      rubric: `(a) 5 marks: correctly derives (t_A/p_A)/(t_B/p_B) = |ε_B|/|ε_A| = 0.25 (2); correctly converts to t_A = 0.5·t_B using price ratio (1); correctly substitutes into revenue constraint and solves t_B = 2.5, t_A = 1.25 (2). (b) 4 marks: correctly computes DWL_A ≈ 12.5 and DWL_B ≈ 37.5, total ≈ 50 (2); correctly derives uniform rate τ ≈ 0.286 from the same revenue constraint and computes total uniform-tax DWL ≈ 77.5–78 (1); correctly concludes the IER-differentiated scheme is more efficient (lower total DWL) than the uniform scheme for the same revenue (1). (c) 4 marks: correct τ* = 1/(1+0.8) ≈ 55.6% (2); correct recomputation τ* = 1/(1+1.2) ≈ 45.5% (1); correct explanation that a higher ETI raises the distortionary cost of a given rate increase, lowering the revenue-maximising rate (1). (d) 4 marks: correctly recomputes DWL at 2t for at least one good and shows the ratio is exactly 4× the original (2); correct general algebraic argument that DWL ∝ t² (1); correct efficiency argument for spreading tax burden across goods rather than concentrating it (1). (e) 3 marks: correctly invokes Diamond-Mirrlees (no taxes on intermediate/production inputs; use of non-linear income tax for redistribution) (1–2, partial credit for one theorem cited correctly); correctly notes the many-person Ramsey rule would add a distributional correction term absent from the single-consumer IER used in part (a) (1).`,
      exampleTopics: [
        'Inverse elasticity rule: deriving the optimal tax ratio and solving jointly with a revenue constraint',
        'Deadweight loss formula DWL ≈ ½t²|ε|Q/p and its t² convexity',
        'Comparing differentiated (IER-optimal) versus uniform commodity taxation for a fixed revenue target',
        'Saez formula for the revenue-maximising top income tax rate and comparative statics in the ETI',
        'Diamond-Mirrlees production efficiency and the many-person Ramsey rule as correctives to the naive IER',
      ],
    },
  },
  {
...
Social security design balances several objectives: consumption smoothing over the lifecycle (the Modigliani-Brumberg life-cycle hypothesis), redistribution from high-wage to low-wage workers (through progressive benefit formulas), insurance against longevity risk (annuitisation), and insurance against disability and early death. The optimal design literature (Diamond and Mirrlees, 2000) shows that forced savings (defined-benefit or defined-contribution mandates) correct myopia and present-bias (hyperbolic discounting agents under-save), while annuitisation corrects adverse selection in private annuity markets. The tension between these objectives explains why real-world social security systems are hybrid: defined benefits provide redistribution and longevity insurance, but individual accounts (as in Chile's privatised system or US 401(k) plans) provide work incentives and reduce political-economy distortions.`,
      ...
      thinkAboutIt: {
        question: `In the Rothschild-Stiglitz separating equilibrium, low-risk individuals are forced to accept only partial coverage even though full insurance would be efficient for a risk-averse individual facing a known, fixed risk. Does mandatory pooling insurance (as under compulsory social security or an individual health insurance mandate) therefore always make the low-risk type better off than the RS separating equilibrium? Derive the boundary condition under which mandatory pooling instead leaves the low-risk type worse off.`,
        answer: `Not always — it depends on the population share of high-risk types, π_H. Under mandatory pooling, everyone pays the same premium P_pool = π_H·θ_H·q + (1−π_H)·θ_L·q (for coverage q), which lies strictly between the two types' actuarially fair rates. The low-risk type gains from moving to full coverage (efficient risk-sharing replaces the partial coverage forced on them in the RS separating equilibrium) but loses from cross-subsidising the high-risk type at a premium above their own fair rate θ_L·q. As π_H → 0, P_pool → θ_L·q, so pooling delivers full coverage at (nearly) the low-risk type's own fair price — this strictly dominates the separating equilibrium's partial coverage, since the low-risk type gets more insurance for almost no extra cost. As π_H → 1, P_pool → θ_H·q, and the low-risk type is paying nearly the high-risk premium for coverage — clearly worse than even the constrained separating contract. Formally, the low-risk type prefers pooling if and only if their expected utility under full coverage at P_pool exceeds their expected utility under the RS separating contract (q_L*, P_L*); since expected utility under pooling is continuous and decreasing in π_H while the separating-equilibrium utility is fixed, there exists a threshold π_H* solving EU_L(pooling; π_H*) = EU_L(separating) such that mandatory pooling helps the low-risk type only when π_H < π_H*. This shows the standard case for mandates (preventing Akerlof unravelling) is not unconditional welfare improvement for every risk type — it is a distributional trade that redistributes from low-risk to high-risk individuals, and its net benefit to the low-risk type depends on how small a share of the population is high-risk.`,
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt: `A health insurance market has 100 individuals: 70 low-risk (probability of a $100,000 loss = 0.01) and 30 high-risk (probability of the same $100,000 loss = 0.05). Insurers are competitive and cannot distinguish risk types. (a) Compute each type's actuarially fair premium and the pooling premium a competitive insurer must charge if it cannot screen types. [4 marks] (b) Assume low-risk individuals exit the pool whenever the premium exceeds 1.5 times their own fair premium. Show that they exit at the initial pooling premium, derive the new (unravelled) equilibrium premium, and state who is insured in equilibrium. [4 marks] (c) Suppose the government instead mandates universal participation at the original pooling premium found in part (a). Let WTP_L denote a low-risk individual's maximum willingness-to-pay for full coverage. State, algebraically, the condition on WTP_L under which the mandate makes a low-risk individual better off than remaining uninsured, and interpret it. [3 marks] (d) A separate unemployment insurance program has consumption while unemployed c_u = $1,800/month and while employed c_e = $3,000/month, with CRRA utility u(c) = c^(1−γ)/(1−γ) and γ = 2. Using the Baily-Chetty condition u'(c_u)/u'(c_e) = 1 + (ε_D/ε_b), compute u'(c_u)/u'(c_e) and hence the implied ratio of the duration elasticity to the consumption-smoothing elasticity if the current replacement rate is assumed optimal. [5 marks] (e) A worker in the EITC phase-out range faces a 21% phase-out rate, a 15% statutory federal marginal income tax rate, and a 7.65% employee-side payroll tax. Compute this worker's total effective marginal tax rate and briefly state its implication for hours worked at the intensive margin. [4 marks]`,
      rubric: `(a) 4 marks: correct fair premium for low risk = 0.01 × 100,000 = $1,000 (1); correct fair premium for high risk = 0.05 × 100,000 = $5,000 (1); correct pooling premium = (70×1,000 + 30×5,000)/100 = $2,200 (2). (b) 4 marks: correctly computes ratio 2,200/1,000 = 2.2 > 1.5, so low-risk exit (1); correctly identifies remaining pool as 30 high-risk only (1); correctly computes new premium = $5,000, equal to the high-risk fair rate, hence stable/no further unravelling (1); correctly states only high-risk individuals remain insured, low-risk are priced out (1). (c) 3 marks: correctly states the mandate benefits the low-risk type iff WTP_L ≥ $2,200 (the mandated premium) (2); correct interpretation that this need not hold even though WTP_L > $1,000 (their fair premium), since the pooling premium is above their fair rate (1). (d) 5 marks: correct u'(c) = c^{-2} (1); correct ratio (c_e/c_u)^2 = (3000/1800)^2 ≈ 2.78 (2); correctly solves 2.78 = 1 + ε_D/ε_b → ε_D/ε_b ≈ 1.78 (1); correct interpretation that the implied moral hazard term is larger than the consumption-smoothing term, consistent with meaningful duration responsiveness (1). (e) 4 marks: correctly sums 21% + 15% + 7.65% (2); correct total ≈ 43.65% (1); correct qualitative statement that this materially discourages additional hours worked in the phase-out region despite the EITC encouraging labour force entry overall (1).`,
      exampleTopics: [
        'Actuarially fair versus pooling premiums and the Akerlof adverse-selection unravelling mechanism',
        'Conditions under which a coverage mandate is welfare-improving for the low-risk type',
        'CRRA utility and the Baily-Chetty sufficient-statistics formula for optimal unemployment insurance',
        'Effective marginal tax rate stacking across payroll tax, income tax, and EITC phase-out',
      ],
    },
  },
  {
...
Public choice theory (Buchanan and Tullock, 1962) extends the logic of individual optimisation to political actors. Politicians maximise votes (or in more cynical models, campaign contributions), bureaucrats maximise budgets (Niskanen, 1971), and interest groups organise to extract rents. Niskanen's model predicts systematic over-expansion of government bureaus: a budget-maximising bureau proposes the largest budget the legislature will accept (a take-it-or-leave-it offer), exploiting information asymmetry about the bureau's true cost function. The result is a budget up to twice the efficient level. Mancur Olson's (1965) collective action model explains why small, concentrated interest groups (e.g., steel producers) are more effective at lobbying than large, diffuse groups (e.g., consumers): each steel producer captures a large share of the rent from a protective tariff, while each consumer bears only a tiny cost — so producers organise and consumers remain rationally ignorant.`,
      ...
      thinkAboutIt: {
        question: `The median voter theorem requires a single policy dimension and single-peaked preferences. Suppose voters instead care about two dimensions simultaneously — say, the tax rate and the composition of spending — with Euclidean preferences (utility decreasing in distance from a two-dimensional bliss point). Does a Condorcet winner generally exist in this setting, and what do Plott's (1967) symmetry condition and McKelvey's (1976) chaos theorem imply about majority-rule outcomes when it does not?`,
        answer: `In two or more dimensions, a Condorcet winner generically fails to exist under Euclidean preferences. Plott (1967) derives the exact condition under which one can exist: bliss points must be arranged in radial symmetry around some point — for every voter's bliss point there must be another voter whose bliss point lies on the opposite ray through that central point, with an odd voter (if any) located exactly at the center. This is a knife-edge, measure-zero condition on the joint distribution of bliss points that is essentially never satisfied by real electorates, so multidimensional policy spaces almost always lack a stable majority-rule winner. McKelvey's (1976) chaos theorem describes what happens instead: when no Condorcet winner exists, a sequence of pairwise majority votes can be engineered, purely through agenda control (the order in which alternatives are pitted against each other), to move the outcome to literally any point in the policy space — including points that every single voter strictly prefers less than the starting point. This is a far stronger instability result than mere cycling; it shows majority rule places essentially no restriction on the final outcome once cycles are possible. The practical implication is that the sharp, stable predictions the MVT delivers in one dimension collapse entirely in multiple dimensions, and real-world political stability must be explained by institutional features outside pure preference aggregation — agenda-setting power, committee gatekeeping, and issue-by-issue voting rules (Shepsle's structure-induced equilibrium) — rather than by the shape of voter preferences alone.`,
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt: `(a) Seven voters have single-peaked bliss points for a tax rate (%): 10, 15, 20, 25, 30, 45, 60. Identify the median voter's bliss point and, using explicit pairwise vote counts, show that this bliss point is the Condorcet winner against both a 20% and a 30% proposal. [4 marks] (b) Four identical firms compete in a Tullock contest for a government-created rent worth R = $40 million, with each firm's win probability equal to x_i / Σx_j. Derive the symmetric Nash equilibrium lobbying expenditure per firm, the total rent dissipated, and the fraction of the rent dissipated. [4 marks] (c) Now suppose the contest success function is generalised to x_i^r / Σx_j^r for a "contest intensity" parameter r > 0. Without deriving the full equilibrium, state and briefly justify what happens to the fraction of the rent dissipated as r → ∞ and as r → 0. [4 marks] (d) Construct a concrete example with 3 voters and 4 alternatives (A, B, C, and an added alternative D) in which introducing D — without any voter reversing their relative ranking of A and B — changes the Borda-count social ranking between A and B. Use this to demonstrate that the Borda count violates Independence of Irrelevant Alternatives. [4 marks] (e) Explain, using Olson's logic of collective action, why Stigler-style regulatory capture is a recurring equilibrium feature of regulated industries rather than a transitional cost that competition eventually erodes away. [4 marks]`,
      rubric: `(a) 4 marks: correctly identifies median = 25% (the 4th of 7 ordered bliss points) (1); correct pairwise count showing 25% beats 20% 4–3 (voters at 25, 30, 45, 60 prefer 25 to 20) (1.5); correct pairwise count showing 25% beats 30% 4–3 (voters at 10, 15, 20, 25 prefer 25 to 30) (1.5). (b) 4 marks: correct FOC and symmetric equilibrium formula x* = R(n−1)/n² (1); correct x* = 40×3/16 = $7.5m per firm (1); correct total dissipation = 4×7.5 = $30m (1); correct fraction dissipated = 30/40 = 75% (1). (c) 4 marks: correctly states that as r → ∞ the contest approaches a deterministic/all-pay-auction-like structure in which spending is driven up toward (or exceeding) full dissipation, with correct intuition (2); correctly states that as r → 0 winning probability becomes independent of effort (uniform 1/n chance regardless of spending), so equilibrium spending and dissipation collapse toward zero, with correct intuition (2). (d) 4 marks: constructs a valid 3-voter profile with 4 alternatives (1); correctly computes Borda scores in the 3-alternative baseline showing A and B tied or in one order (1); correctly computes Borda scores after inserting D and shows the A-vs-B ranking changes despite unchanged pairwise A-vs-B rankings by every voter (2). (e) 4 marks: correctly identifies that regulated industries are a concentrated group with high per-firm stakes able to overcome collective-action costs, while consumers are diffuse with low per-capita stakes and face free-rider problems in organising opposition (2); correctly explains why this asymmetry persists as a stable equilibrium (not merely a transitional cost), since the underlying group-size asymmetry does not erode with time or competition among firms within the captured industry (2).`,
      exampleTopics: [
        'Median voter theorem: identifying the median bliss point and proving the Condorcet-winner property via pairwise majority comparisons',
        'Tullock contest model: symmetric Nash equilibrium lobbying expenditure and rent dissipation',
        'Generalised contest success functions and the effect of contest intensity on dissipation',
        'Constructing explicit counterexamples to test Arrow-style axioms (IIA) against scoring rules like Borda count',
        'Olson\'s logic of collective action applied to Stigler\'s theory of regulatory capture',
      ],
    },
  },
  {
...
Distributional weights in CBA reflect the declining marginal utility of income: if MU(income) = y^(−e), the weight on a benefit to an individual with income y relative to a reference income ȳ is λ = (ȳ/y)^e. With e = 1 (logarithmic utility, standard in many calibrations), a benefit to someone earning half the average income counts twice as much as the same benefit to an average-income person. Applying distributional weights transforms CBA from a Kaldor-Hicks (potential Pareto) criterion toward a social welfare maximisation approach. Critics note that distributional concerns should be addressed through the tax-transfer system (Diamond-Mirrlees theorem), not through distorting project selection — if the government can redistribute optimally, unweighted CBA plus redistribution is first-best. However, when redistribution is politically constrained, weighted CBA provides a second-best improvement in social welfare by steering public investment toward projects that benefit lower-income groups.`,
      ...
      thinkAboutIt: {
        question: `VSL estimates are typically derived from hedonic wage regressions among working-age individuals, disproportionately in risky blue-collar occupations. When a regulatory agency then applies a single national VSL figure (e.g., the EPA's ~$11.6m) to value mortality reductions among retirees, children, or the chronically ill, what specific econometric and ethical problems arise from this extrapolation? Should the VSL vary with age, income, or health status in official cost-benefit practice, and what is the strongest counter-argument to actually implementing such variation?`,
        answer: `The econometric problem is external validity: hedonic wage regressions identify the compensating wage differential for risk among a selected population — working-age individuals willing to accept risky jobs — whose risk preferences and residual life expectancy differ systematically from retirees, children, or the chronically ill, so extrapolating the same coefficient to those groups is an out-of-sample projection with no direct empirical support. The theoretically consistent age adjustment replaces VSL with the value of a statistical life-year (VSLY): a life saved late in life represents fewer expected remaining years than one saved early, so total value (VSL = VSLY × expected remaining years) should in principle decline with age even if the value per remaining year is roughly constant or even rising with age (since older individuals are typically wealthier and can afford higher WTP per year). This is not merely academic — the US EPA proposed exactly this kind of age-adjusted "senior discount" for its 2003 Clear Skies Act analysis, applying a lower VSL to those over 65, and was forced to withdraw it after intense public backlash framed it as valuing older lives less. The income dimension raises a parallel but distinct equity problem: WTP for risk reduction rises with income (empirical income elasticity of VSL is roughly 0.5–0.6), so a strict WTP-based approach would assign a lower VSL to poorer individuals and poorer countries, which would systematically bias public investment toward protecting the lives of the rich over the poor — the opposite of most societies' distributive commitments. The standard practical resolution is to use a single, uniform VSL regardless of age, income, or health status, trading theoretical WTP-consistency for horizontal equity in how the government values different citizens' lives, even though this necessarily misstates the pure economic willingness-to-pay for at least some subgroups.`,
      },
    },
    flashcards: [
      {
    ...
    lessonAssignment: {
      prompt: `A public health project costs $30 million in year 0. It prevents 10 statistical deaths in year 1, 8 in year 2, and 6 in year 3, with VSL = $7 million per statistical life throughout. (a) Using a social discount rate r = 3%, compute the present value of benefits, the NPV, and the benefit-cost ratio. State whether the project passes. [5 marks] (b) Recompute the NPV using r = 7% (a Nordhaus-style descriptive rate) instead of 3%. Compare the two NPVs and comment on why this project's ranking is relatively insensitive to the discount rate choice, in contrast to very long-horizon projects such as climate mitigation. [4 marks] (c) Suppose 70% of the value of prevented deaths (by PV share) accrues to a low-income community with average income $25,000, and the remaining 30% accrues to a high-income community with average income $150,000; economy-wide average income is $60,000. Apply distributional weights λ_i = (ȳ/y_i)^1 to the two benefit shares (using the PV of benefits from part (a)) and compute the distributionally weighted PV of benefits and weighted NPV. Compare to the unweighted NPV. [5 marks] (d) A companion health intervention generates 500 QALYs at a cost of $12.5 million. Compute the cost per QALY in USD, convert to GBP at $1 = £0.80, and state whether it would be funded under NICE's £20,000–£30,000/QALY threshold. [3 marks] (e) Explain briefly why NPV > 0 (Kaldor-Hicks efficiency) is neither necessary nor sufficient for a project to be normatively desirable once the distributional weighting in part (c) is taken seriously, referencing the Diamond-Mirrlees argument that redistribution is better handled through the tax system than through project selection. [3 marks]`,
      rubric: `(a) 5 marks: correct annual benefits $70m/$56m/$42m (1); correct discounting to PV ≈ $67.96m/$52.79m/$38.44m (2); correct total PV(B) ≈ $159.2m and NPV ≈ $129.2m (1); correct BCR ≈ 5.3 and conclusion the project passes decisively (1). (b) 4 marks: correctly recomputes PV(B) ≈ $148.6m and NPV ≈ $118.6m at r = 7% (2); correctly notes NPV remains strongly positive under both rates (1); correct explanation that near-term benefit horizons are far less discount-rate-sensitive than the multi-century horizons relevant to climate policy, where small rate differences compound into order-of-magnitude present-value differences (1). (c) 5 marks: correct λ_low = 60,000/25,000 = 2.4 and λ_high = 60,000/150,000 = 0.4 (2); correctly applies weights to the 70%/30% split of PV(B) ≈ $159.2m (1); correct weighted PV(B) ≈ $286.5m and weighted NPV ≈ $256.5m (1); correct comparison noting the weighted NPV is substantially higher than the unweighted NPV because benefits skew toward the lower-income community (1). (d) 3 marks: correct cost/QALY = $12,500,000/500 = $25,000 (1); correct GBP conversion = £20,000 (1); correct conclusion that this sits at the bottom edge of NICE's threshold range, i.e., borderline but likely funded (1). (e) 3 marks: correctly notes Kaldor-Hicks efficiency only requires that compensation could occur, not that it does, so NPV > 0 does not guarantee an equitable outcome (1); correctly references Diamond-Mirrlees-style reasoning that if the tax-transfer system can redistribute optimally, unweighted CBA plus redistribution is first-best, making project-level distributional weighting a second-best tool only when redistribution is politically constrained (2).`,
      exampleTopics: [
        'NPV and benefit-cost ratio calculation with VSL-based mortality benefits under discounting',
        'Sensitivity of NPV to the choice of social discount rate, and why horizon length matters',
        'Applying distributional weights (ȳ/y_i)^e to benefit streams and comparing weighted versus unweighted NPV',
        'QALY cost-effectiveness thresholds and currency conversion in health technology assessment',
        'Kaldor-Hicks efficiency versus social welfare, and the Diamond-Mirrlees case against using project selection for redistribution',
      ],
    },
  },
]
