...
export const lessons: Lesson[] = [
  // ── Lesson 1: The Marketing Mix — 4Ps ────────────────────────────────────────
  {
    ...
    content: {
      ...
      isStub: false,
      thinkAboutIt: {
        question: `A sneaker brand doubles its price, releases only 500 pairs per "drop" through a lottery-entry system on its own app, and refuses to run any paid advertising — relying entirely on scarcity to generate word-of-mouth and press coverage. A critic argues the brand is "bad at marketing" because it spends nothing on Promotion. Using the marketing mix framework, is this critique fair?`,
        answer: `The critique misunderstands how the 4Ps interact — it treats Promotion as synonymous with paid advertising, when Promotion actually covers any activity that communicates and reinforces the product's value, including publicity generated by other elements of the mix. Here, the brand's Product decision (limited-run design) and Place decision (app-only, lottery access) are engineered specifically to create scarcity, which functions as a promotional trigger: media outlets cover the drop, resellers bid up secondary-market prices, and consumers who cannot get a pair talk about the brand anyway. This is a deliberate PR and word-of-mouth strategy substituting for paid promotion, not an absence of promotional thinking. The doubled Price also reinforces the exclusivity story, so all four Ps are working together toward the same premium, scarce positioning rather than one P compensating for a weakness in another. A more accurate critique would ask whether this strategy reaches enough of the target segment to sustain revenue, not whether the brand "does no marketing" — spending zero dollars on ads is a Promotion choice, not a Promotion vacuum.`,
      },
    },
    lessonAssignment: {
      prompt: `You are a marketing consultant hired by BrightPack Snacks, a 3-year-old protein bar startup. BrightPack sells its $3.49 bars exclusively through 40 independent gyms and its own Shopify store, spends $0 on paid advertising, and relies entirely on gym-owner recommendations. Annual revenue is $620,000, but growth has stalled at 4% for two straight years. Its main competitor, RxBar, earns over $50 million annually distributed through Target, Whole Foods, and Amazon, and runs a national digital ad campaign.\n\n(a) Using specific evidence from the scenario, diagnose which element(s) of BrightPack's current marketing mix are most limiting its growth relative to RxBar. [4 marks]\n\n(b) Recommend a new distribution (Place) strategy for BrightPack, naming at least two specific channel types it should pursue, and justify each against its target segment. [6 marks]\n\n(c) BrightPack is considering national retail expansion. Recommend whether it should hold, raise, or lower its $3.49 price, referencing cost-plus versus value-based pricing in your justification. [4 marks]\n\n(d) Design a promotional campaign — including channel and core message — that lets BrightPack scale beyond gym referrals without abandoning the authenticity that built its current loyal base. [6 marks]`,
      rubric: `(a) Correctly identifies Place (limited to 40 gyms + owned site, no mass retail) and Promotion ($0 ad spend, no reach beyond existing gym network) as the binding constraints, using RxBar's national distribution and ad spend as contrasting evidence (2 pts). Explains that Product and Price are not the primary constraints since demand exists but cannot scale through current channels (2 pts). Total: 4 pts.\n\n(b) Names at least two concrete distribution channels (e.g., regional grocery chains, Amazon, specialty retailers, direct-to-consumer subscription) (2 pts). Justifies each choice against BrightPack's health-conscious, gym-going target segment with specific reasoning (2 pts). Shows awareness of trade-offs (e.g., margin compression from retail listing fees) (2 pts). Total: 6 pts.\n\n(c) Makes a clear, justified pricing recommendation rather than a vague statement (2 pts). Correctly applies cost-plus vs. value-based pricing logic to the national-retail context (2 pts). Total: 4 pts.\n\n(d) Names a specific promotional channel appropriate to the target segment (2 pts). Articulates a core message that preserves the brand's authentic, community-endorsed positioning (2 pts). Explains how the campaign scales reach without contradicting the gym-referral origin story (2 pts). Total: 6 pts.`,
      exampleTopics: [
        'Distinguish which specific P (not "marketing" generally) is the binding constraint on growth, using the RxBar comparison as evidence.',
        'Recommend named, realistic distribution channels appropriate for a protein-bar startup, not generic "sell more places" advice.',
        'Apply cost-plus vs. value-based pricing reasoning explicitly when justifying a pricing decision for retail expansion.',
        'Design a promotional message that scales reach while staying consistent with the brand\'s existing Product, Price, and Place positioning.',
      ],
    },
    flashcards: [
      {
  ...
  // ── Lesson 2: Consumer Behavior & Segmentation ────────────────────────────────
  {
    ...
    content: {
      ...
      isStub: false,
      thinkAboutIt: {
        question: `Two consumers share identical demographics — both are 32-year-old women earning $85,000 in the same city. One buys a Tesla Model 3; the other buys a Toyota Camry Hybrid. If demographic segmentation predicts similar purchase behavior for people with similar demographic profiles, what does this divergence reveal about the limits of demographic segmentation, and which segmentation base would better explain the difference?`,
        answer: `This divergence shows that demographic variables are correlated with purchase behavior at best, not causal drivers of it — two people can share every measurable demographic trait yet make opposite purchase decisions because demographics say nothing about their values, priorities, or lifestyle. Psychographic segmentation would better explain the split: one consumer may prioritize environmental identity, technology enthusiasm, and status signaling associated with Tesla, while the other values reliability, lower total cost of ownership, and a more conservative risk profile associated with Toyota's brand reputation. Behavioral segmentation could add further explanatory power, for example by looking at how each consumer researched the purchase, how brand-loyal they are, or what benefits they weighted most heavily (performance and image versus dependability and resale value). The lesson for a marketer is that demographic data is useful for narrowing a target market to a reachable size and estimating its purchasing power, but it should never be the sole basis for message design — two demographically identical consumers can require completely different value propositions, and treating them as one addressable segment would waste marketing spend on whichever message resonates with only half the group.`,
      },
    },
    lessonAssignment: {
      prompt: `PulseFit, a fitness technology company, is planning to launch a new $249 fitness tracker. Market research has identified three potential segments: (1) 1.2 million competitive marathon runners who track pace splits and VO2 max and are willing to pay a premium for accuracy; (2) 8.5 million casual gym-goers focused on step count and habit-building, who are price-sensitive around $99; (3) 400,000 corporate wellness program buyers who purchase in bulk (500+ units per order) at negotiated volume pricing for employee health incentives.\n\n(a) Using at least two segmentation bases, profile each of the three segments named above. [4 marks]\n\n(b) Recommend which targeting strategy (undifferentiated, differentiated, concentrated, or micromarketing) PulseFit should adopt for its $249 launch, and justify your choice using the segment size and profitability data given. [6 marks]\n\n(c) Map the marathon-runner segment's likely path through the five-stage consumer decision-making process, identifying one specific marketing tactic PulseFit could use to intervene at each of two stages. [4 marks]\n\n(d) Evaluate the risk of PulseFit pursuing all three segments simultaneously versus focusing only on the corporate wellness segment, using the criteria of measurability, substantiality, accessibility, and actionability. [6 marks]`,
      rubric: `(a) Correctly profiles each segment using at least two named bases (e.g., behavioral: usage occasion/benefits sought; demographic: purchasing role; psychographic: performance-driven identity) (1 pt per segment profiled correctly, up to 3 pts) plus overall clarity distinguishing the three (1 pt). Total: 4 pts.\n\n(b) Names a specific targeting strategy (2 pts). Justifies using segment size and price sensitivity/profitability data from the scenario, not generic reasoning (2 pts). Acknowledges a trade-off of the chosen strategy (2 pts). Total: 6 pts.\n\n(c) Correctly sequences at least three of the five stages for the marathon-runner segment (2 pts). Names two specific, stage-appropriate marketing tactics (e.g., targeted content at information search, a trial period to reduce post-purchase dissonance) (2 pts). Total: 4 pts.\n\n(d) Applies all four segmentation criteria (measurable, substantial, accessible, actionable) explicitly to compare the two strategic options (4 pts). Reaches a justified recommendation with a specific risk identified (2 pts). Total: 6 pts.`,
      exampleTopics: [
        'Use at least two distinct segmentation bases (not just demographic) when profiling each of the three named PulseFit segments.',
        'Tie the targeting-strategy recommendation to the actual size and price-sensitivity figures given, not a generic preference for one strategy.',
        'Apply the five-stage consumer decision-making process specifically to the marathon-runner segment, with tactics matched to each stage.',
        'Use the measurable/substantial/accessible/actionable criteria explicitly, rather than describing segment attractiveness in vague terms.',
      ],
    },
    flashcards: [
      {
  ...
  // ── Lesson 3: Marketing Research Methods ─────────────────────────────────────
  {
    ...
    content: {
      ...
      isStub: false,
      thinkAboutIt: {
        question: `A company runs a statistically significant survey showing 82% of respondents "like" a new product concept and greenlights production based on that number alone. Six months later, actual sales are far below forecast. What research methodology error most plausibly explains the gap between stated survey preference and real purchase behavior, and what additional method would have caught it before launch?`,
        answer: `The core error is treating stated intent from a single quantitative instrument as a reliable predictor of revealed purchase behavior, when the two frequently diverge — a phenomenon sometimes called the intention-behavior gap. Survey respondents face no real financial trade-off when they say they "like" a concept; there is no price to weigh against competing purchases, no inconvenience of finding the product on a shelf, and often a social desirability bias toward giving an agreeable answer to a researcher. A statistically significant sample size only guarantees that the 82% figure is unlikely to be due to chance within that survey population — it says nothing about whether the underlying question measured real purchase intent rather than polite approval. The company should have paired the quantitative survey with a behavioral or experimental method that forces a real trade-off, such as a limited pilot launch, an A/B priced pre-order test, or in-store observation of trial-to-purchase conversion, before committing to full production. Any of these would reveal the gap between "liking" a concept and actually paying for it, which is precisely the gap that sank the forecast.`,
      },
    },
    lessonAssignment: {
      prompt: `Fresca Juice Co. is deciding whether to launch a $6.99 cold-pressed juice line. An online survey of 400 respondents found that 71% said they would "definitely" or "probably" buy the product. Secondary research from a Nielsen beverage report shows the cold-pressed juice category grew 3% last year. A pilot program at three Whole Foods stores offering free samples found that only 9% of samplers made a purchase within 30 days.\n\n(a) Classify each of the three data points given (the 400-respondent survey, the Nielsen report, and the pilot store conversion data) as primary or secondary and as qualitative or quantitative. [4 marks]\n\n(b) Explain why the 71% stated purchase intent from the survey likely overstates real demand, referencing the gap between stated and revealed preference and the pilot store's 9% conversion rate. [4 marks]\n\n(c) Design a follow-up primary research method — specifying the sample, the method, and one key question it would ask — that would help resolve the gap between survey intent and actual purchase behavior. [6 marks]\n\n(d) Recommend whether Fresca should proceed to full national launch, delay for more research, or launch in limited markets first, justifying your recommendation using all three data sources given. [6 marks]`,
      rubric: `(a) Correctly classifies all three: survey = primary/quantitative, Nielsen report = secondary/quantitative, pilot store data = primary/quantitative (1 pt each, up to 3 pts) with correct terminology throughout (1 pt). Total: 4 pts.\n\n(b) Identifies that stated intent (71%) does not reflect an actual financial trade-off while the pilot conversion (9%) reflects real purchase behavior (2 pts). Explicitly names the stated-vs-revealed preference gap or equivalent reasoning (2 pts). Total: 4 pts.\n\n(c) Specifies a realistic sample (2 pts), names an appropriate primary method matched to the research gap (e.g., extended regional test market, priced pre-order test, follow-up interviews with samplers who did not purchase) (2 pts), and writes one specific, relevant research question (2 pts). Total: 6 pts.\n\n(d) Reaches a clear, justified recommendation (2 pts) that explicitly weighs all three data sources against each other rather than citing only one (4 pts). Total: 6 pts.`,
      exampleTopics: [
        'Correctly classify each data source along both the primary/secondary axis and the qualitative/quantitative axis.',
        'Explain the stated-vs-revealed preference gap using the specific 71% vs. 9% figures given, not a generic definition.',
        'Design a follow-up primary research method that specifically targets the identified gap, with a concrete sample and question.',
        'Weigh all three data points together when making the final launch recommendation, rather than relying on the most favorable one.',
      ],
    },
    flashcards: [
      {
  ...
  // ── Lesson 4: Digital & Social Media Marketing ────────────────────────────────
  {
    ...
    content: {
      ...
      isStub: false,
      thinkAboutIt: {
        question: `A brand pays a mega-influencer (5 million followers) $30,000 for a sponsored post that generates 50,000 likes (1% engagement) but only 12 tracked sales at a $50 average order value. A rival brand pays a micro-influencer (40,000 followers) $4,000 for a post that generates 3,000 likes (7.5% engagement) and 180 tracked sales at the same average order value. Calculate the ROAS for each campaign and explain why engagement rate served as an early warning sign before the sales data came in.`,
        answer: `The mega-influencer campaign generated 12 × $50 = $600 in revenue against $30,000 in spend, for a ROAS of just 0.02x — the brand lost nearly all of its ad spend. The micro-influencer campaign generated 180 × $50 = $9,000 in revenue against $4,000 in spend, for a ROAS of 2.25x — more than a hundred times more efficient per dollar. Engagement rate was a leading indicator of this gap because it measures how actively an audience interacts with content relative to its size, which correlates with how much that audience trusts and pays attention to the influencer's recommendations; a 1% engagement rate signals a largely passive, scroll-past audience, while 7.5% signals an audience that reads captions, clicks links, and treats the influencer's endorsement as credible. Marketers who wait for final sales data to judge a campaign lose weeks of optimization time, whereas checking engagement rate within the first hours of a post going live would have flagged the mega-influencer campaign as underperforming well before the $30,000 was fully justified by results. This is why DECA-style digital marketing recommendations should specify engagement rate benchmarks alongside ROAS targets, not treat them as separate metrics measured at different stages of the funnel.`,
      },
    },
    lessonAssignment: {
      prompt: `GlowLab, a direct-to-consumer skincare brand, ran three campaigns last quarter. Campaign A: $12,000 on Google Search ads, generating $54,000 in tracked revenue. Campaign B: $12,000 on a mega-influencer sponsorship (2.1 million followers, 0.8% engagement rate), generating $9,600 in tracked revenue. Campaign C: a $3,000 test budget spread across five micro-influencers (15,000–40,000 followers, averaging 6% engagement), generating $13,500 in tracked revenue.\n\n(a) Calculate the ROAS for all three campaigns and rank them from most to least efficient. [4 marks]\n\n(b) Explain why engagement rate is a useful leading indicator of ROAS, using Campaign B and Campaign C as contrasting evidence. [4 marks]\n\n(c) Recommend how GlowLab should reallocate next quarter's total $27,000 digital budget across the three channel types, with specific dollar amounts and justification for each. [6 marks]\n\n(d) Identify one first-party data strategy GlowLab could implement to reduce its reliance on paid influencer spend over time, and explain how its success would be measured. [6 marks]`,
      rubric: `(a) Correctly calculates all three ROAS figures: A = $54,000 ÷ $12,000 = 4.5x; B = $9,600 ÷ $12,000 = 0.8x; C = $13,500 ÷ $3,000 = 4.5x (3 pts, 1 per correct calculation) and correctly ranks A/C above B (1 pt). Total: 4 pts.\n\n(b) Explains that Campaign C's high engagement rate (6%) predicted its strong ROAS while Campaign B's low engagement rate (0.8%) predicted its poor ROAS, before or independent of final sales figures (2 pts). Generalizes this into a reusable principle for evaluating campaigns early (2 pts). Total: 4 pts.\n\n(c) Proposes specific dollar reallocations summing to $27,000 (2 pts). Justifies increasing/maintaining spend on Search and micro-influencers based on their calculated ROAS while cutting or eliminating mega-influencer spend (2 pts). Shows awareness of diminishing returns or budget-scaling limits (2 pts). Total: 6 pts.\n\n(d) Names a specific, realistic first-party data tactic (e.g., email capture via loyalty program, SMS opt-in with discount, gated content) (2 pts). Explains how it reduces dependence on paid influencer spend specifically (2 pts). Proposes a specific, measurable success metric (2 pts). Total: 6 pts.`,
      exampleTopics: [
        'Show the ROAS formula and calculation explicitly for each campaign rather than stating the ranking without working.',
        'Use engagement rate as a predictive, not merely descriptive, metric when explaining Campaign B vs. C performance.',
        'Reallocate the budget with specific dollar figures tied directly to the calculated ROAS of each channel.',
        'Propose a first-party data strategy that plausibly reduces paid-influencer dependence, with a concrete measurement method.',
      ],
    },
    flashcards: [
      {
  ...
  // ── Lesson 5: DECA Marketing Events Prep ─────────────────────────────────────
  {
    ...
    content: {
      ...
      isStub: false,
      thinkAboutIt: {
        question: `During the judge interaction phase of a role-play, a judge asks a follow-up question that is not explicitly listed among the Performance Indicators on the event card. A competitor believes they should decline to answer, since it was not part of the required PIs. Is this the right approach? Explain how judges evaluate follow-up questions relative to the explicit PI list.`,
        answer: `Declining to answer is the wrong approach and would likely cost the competitor points rather than protect them. The listed Performance Indicators define the minimum content a role-play must cover, not the outer limit of what a judge may ask about — judges routinely probe beyond the explicit PIs to test whether a competitor's understanding is genuine and adaptable rather than a memorized script tied narrowly to the printed list. Declining to answer, or stating that a topic "wasn't covered," signals exactly the surface-level preparation that keeps competitors out of the top scoring band, since the judge interaction criterion specifically rewards depth of understanding and the ability to reason through unexpected angles. The stronger approach is to acknowledge the question directly, apply the same frameworks and reasoning used in the prepared presentation to the new angle, and connect the answer back to the original recommendation — even an imperfect but well-reasoned attempt scores higher than a refusal. In practice, this means a competitor should treat the PI list as the required floor for their opening presentation, while preparing broader business and economic reasoning skills that let them respond credibly to whatever direction the judge's curiosity takes.`,
      },
    },
    lessonAssignment: {
      prompt: `You are competing in DECA's Sports & Entertainment Marketing (SEM) role-play event. The scenario card reads: "You are a marketing associate for the Ridgeview Riverhawks, a minor league baseball team. Season ticket renewals have dropped from 3,200 to 2,450 households (a 23% decline) over the past two years, while single-game walk-up attendance has held steady at roughly 65,000 fans per season. The general manager has budgeted $40,000 for a renewal-focused marketing campaign and wants a plan within one week." The Performance Indicators listed on the event card are: (1) Explain the concept of market segmentation, (2) Describe factors used to segment markets, (3) Explain the nature of sales promotion, (4) Describe the use of pricing tactics in marketing.\n\n(a) Identify the core business problem the Riverhawks face, distinguishing it from a surface symptom, and explain why the steady walk-up attendance figure is relevant context for your diagnosis. [4 marks]\n\n(b) Segment the lapsed season-ticket-holder base into at least two distinct groups using named segmentation bases, and explain why each group requires a different renewal message. [4 marks]\n\n(c) Design one sales promotion and one pricing tactic — each explicitly tied to one of the Performance Indicators above — that fit within the $40,000 budget, including an approximate dollar allocation for each. [6 marks]\n\n(d) Write the closing 3–4 sentences of your role-play presentation as you would deliver them to the judge, addressing all four Performance Indicators and inviting Q&A. [6 marks]`,
      rubric: `(a) Correctly identifies the core problem as season-ticket renewal/loyalty erosion rather than "low attendance" generally (2 pts), using the steady walk-up figure as evidence that overall fan interest persists but renewal-specific loyalty has weakened (2 pts). Total: 4 pts.\n\n(b) Names at least two segmentation bases applied to lapsed ticket holders (e.g., behavioral: tenure/loyalty level; demographic: household composition; psychographic: reasons for lapsing) (2 pts) and explains a distinct renewal message for each group (2 pts). Total: 4 pts.\n\n(c) Sales promotion is specific and tied to PI 3 (2 pts); pricing tactic is specific and tied to PI 4 (2 pts); both include a plausible dollar allocation within the $40,000 budget (2 pts). Total: 6 pts.\n\n(d) Closing explicitly references or implies all four PIs (segmentation concept, segmentation factors, sales promotion, pricing tactic) (4 pts), ends with a confident, concise call to action inviting judge questions (2 pts). Total: 6 pts.`,
      exampleTopics: [
        'Separate the true underlying problem (renewal/loyalty erosion) from the surface symptom (falling attendance), using the walk-up data as evidence.',
        'Apply named segmentation bases specifically to lapsed season-ticket holders, not to fans in general.',
        'Tie the sales promotion and pricing tactic explicitly back to the Performance Indicators listed on the event card, with a budget allocation.',
        'Deliver a closing that hits every PI concisely and ends with a confident invitation for judge questions, matching real DECA role-play format.',
      ],
    },
    flashcards: [
      {
